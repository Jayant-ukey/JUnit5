...
class MathUtilsTest {
	...
	static void beforeAllInit() {
		//BeforeAll method gets call even before the instance of this class created. So this method need to be static.
		// Static method can get call, before the instance of class creation.
